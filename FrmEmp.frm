    ...
    Select Case CRUD
        Case 1: 'Cadastrar
            ...
            ElseIf Trim(txtlogin.Text) = "" Then
                MsgBox "O Campo login está em branco,favor preencher corretamente.", vbExclamation, "Agenda_Personalizada"
                txtlogin.SetFocus
                Exit Sub
            ElseIf Trim(txtsenha.Text) = "" Then
                MsgBox "O Campo senha está em branco,favor preencher corretamente.", vbExclamation, "Agenda_Personalizada"
                txtsenha.SetFocus
                Exit Sub
            End If
